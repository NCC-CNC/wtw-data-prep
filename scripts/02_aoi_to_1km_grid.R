...
AOI <- "C:/Data/PRZ/WTW/CONSTECH/SW_ONTARIO_V3/PU/AOI.shp" # <- CHANGE TO YOUR SHP PATH

# Output folder 
OUTPUT <- "C:/Data/PRZ/WTW/CONSTECH/SW_ONTARIO_V3/PU" # <- CHANGE TO YOUR OUTPUT FOLDER PATH. POINT TO "PU" FOLDER.
