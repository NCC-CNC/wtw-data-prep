...
aoi_path <- "AOI/AOI.tif"
aoi_data_folder <- "National" # <--- THIS IS THE LOCATION TO STORE THE CLIPPED RASTERS IN THE PROJECT FOLDER

## Create output folder directory ----
dir.create(file.path(aoi_data_folder))
dir.create(file.path(aoi_data_folder, "_Tables"))
dir.create(file.path(aoi_data_folder, "Excludes"))
dir.create(file.path(aoi_data_folder, "Includes"))
dir.create(file.path(aoi_data_folder, "Themes"))
dir.create(file.path(aoi_data_folder, "Weights"))

dir.create(file.path(aoi_data_folder, "Themes", "ECCC_CH"))
dir.create(file.path(aoi_data_folder, "Themes", "ECCC_SAR"))
dir.create(file.path(aoi_data_folder, "Themes", "IUCN_AMPH"))
dir.create(file.path(aoi_data_folder, "Themes", "IUCN_BIRD"))
dir.create(file.path(aoi_data_folder, "Themes", "IUCN_MAMM"))
dir.create(file.path(aoi_data_folder, "Themes", "IUCN_REPT"))
dir.create(file.path(aoi_data_folder, "Themes", "LC"))
dir.create(file.path(aoi_data_folder, "Themes", "KM"))
dir.create(file.path(aoi_data_folder, "Themes", "NSC_END"))
dir.create(file.path(aoi_data_folder, "Themes", "NSC_SAR"))
dir.create(file.path(aoi_data_folder, "Themes", "NSC_SPP"))

# Copy / paste LUT ----
LUT <- list.files(file.path(input_data_path, "/national/species"), pattern='.xlsx$|.csv$', full.names = T)
file.copy(LUT, file.path(aoi_data_folder, "_Tables"))
...
matrix_overlap  <- matrix_intersect(natdata_rij, aoi_rij) 
matrix_to_raster(ncc_1km_idx, matrix_overlap, aoi_1km0,
                 paste0(aoi_data_folder, "/Themes/LC"), "T_LC_", "INT2U")
...
matrix_overlap  <- matrix_intersect(natdata_rij, aoi_rij) 
matrix_to_raster(ncc_1km_idx, matrix_overlap, aoi_1km0,
                 paste0(aoi_data_folder, "/Themes/LC"), "T_LC_", "FLT4S")
...
matrix_overlap  <- matrix_intersect(natdata_rij, aoi_rij) 
matrix_to_raster(ncc_1km_idx, matrix_overlap, aoi_1km0,
                 paste0(aoi_data_folder, "/Themes/KM"), "T_KM_", "FLT4S")
...
matrix_overlap  <- matrix_intersect(natdata_rij, aoi_rij) 
matrix_to_raster(ncc_1km_idx, matrix_overlap, aoi_1km0,
                 paste0(aoi_data_folder, "/Weights"), "W_", "FLT4S")
...
matrix_overlap  <- matrix_intersect(natdata_rij, aoi_rij) 
matrix_to_raster(ncc_1km_idx, matrix_overlap, aoi_1km0,
                 paste0(aoi_data_folder, "/Includes"), "I_", "INT1U")

# 5.0 Generate species list csv ------------------------------------------------

## List files in root folder
output_tiffs <- list.files(aoi_data_folder, pattern='.tif$', full.names = T, 
                      recursive = T)
...
write.csv(species, 
          paste0(aoi_data_folder, "/Themes/SPECIES.csv"), 
          row.names = FALSE)
